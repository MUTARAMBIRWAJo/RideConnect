...
<head>
    ...
    <title>Login — RideConnect Admin</title>
    ...
    <div class="layout">
        <section class="left-panel">
            <div class="login-card">
                ...
                <h1>Welcome back</h1>
                <p class="subtitle">Log in to access the RideConnect Admin account</p>
                ...
                <p class="helper">Need access? <a class="link" href="{{ route('admin.register') }}">Request an admin account</a></p>
            </div>
        </section>
        ...
        <aside class="right-panel" aria-hidden="true">
            ...
            <div class="hero">
                <h2>RideConnect Operations & Ticketing Console</h2>
                <div class="hero-art">
                    <svg viewBox="0 0 760 360" width="100%" height="auto" role="img" aria-label="Admin portal illustration">
                        <defs>
                ...
                <p>
                    Manage trips, tickets, invoices, and passenger support from one secure admin workspace.
                    RideConnect helps your team coordinate operations efficiently with reliable, auditable workflows.
                </p>
            </div>
        </aside>
    </div>
