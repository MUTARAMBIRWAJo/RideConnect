    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .divider::after {
            content: '';
            flex: 1;
            border-top: 1px solid var(--rc-slate-200);
        }
    ...
    <div class="layout">
        <section class="left-panel">
            <div class="login-card">
                ...
                <p class="helper">Don’t have an account? <a class="link" href="{{ route('register') }}">Create one</a></p>
            </div>
        </section>
            ...
            <div class="hero">
                ...
                <div class="hero-art">
                    <svg viewBox="0 0 760 360" width="100%" height="360" role="img" aria-label="Portal illustration">
                        ...
                        <circle cx="250" cy="180" r="140" fill="url(#g)" opacity=".4"/>
                        <rect x="320" y="80" width="360" height="210" rx="14" fill="rgba(255,255,255,.85)"/>
                ...
                <p>
                    RideConnect streamlines trips, ticketing, and support operations across passengers, drivers, and administrators.
                    Access your account to manage transport workflows with transparency, accountability, and service quality.
                </p>
            </div>
        </aside>
    </div>
