...
@section('title', 'All Users - RideConnect Admin')
            ...
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    ...
                    <div class="ml-6 flex space-x-4">
                        ...
                        <a href="{{ route('admin.users.index') }}" class="bg-green-100 text-green-700 px-3 py-2 rounded-md text-sm font-medium">All Users</a>
                        <a href="{{ route('admin.users.pending') }}" class="text-gray-500 hover:text-gray-700 px-3 py-2 rounded-md text-sm font-medium">Pending Approvals</a>
                    </div>
                </div>
                <div class="flex items-center">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <p class="mt-2 text-sm text-gray-600">
                    ...
                    @if(Auth::user()->isSuperAdmin())
                        As SuperAdmin, you have access to all users.
                    @else
                        As Admin, you can only view mobile app users (Passengers and Drivers).
                    @endif
                </p>
            </div>
        </header>
                                            ...
                                            <div class="sm:flex">
                                                ...
                                                <p class="mt-2 flex items-center text-sm text-gray-500 sm:mt-0 sm:ml-6">
                                                    @if($user->is_approved)
                                                        ...
                                                        Approved {{ $user->approved_at ? $user->approved_at->diffForHumans() : '' }}
                                                    @else
                                                        <svg class="flex-shrink-0 mr-1.5 h-5 w-5 text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
