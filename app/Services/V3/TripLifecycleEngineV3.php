...
class TripLifecycleEngineV3
{
    ...
    protected const TRANSITIONS = [
        'REQUESTED' => ['DRIVER_SELECTED', 'MATCHING', 'CANCELLED'],
        'DRIVER_SELECTED' => ['NOTIFIED', 'CANCELLED'],
        'NOTIFIED' => ['ACCEPTED', 'REJECTED', 'CANCELLED', 'MATCHING'],
        'MATCHING' => ['NOTIFIED', 'CANCELLED', 'FAILED'],
        'ACCEPTED' => ['DRIVER_ARRIVED', 'IN_PROGRESS', 'CANCELLED'],
        'REJECTED' => ['MATCHING', 'CANCELLED', 'FAILED'],
